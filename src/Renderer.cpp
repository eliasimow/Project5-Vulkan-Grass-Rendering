...
void Renderer::CreateComputeDescriptorSetLayout() {
	//in blades:
	VkDescriptorSetLayoutBinding bladesInBinding = {};
	bladesInBinding.binding = 0;
	bladesInBinding.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
	bladesInBinding.descriptorCount = 1;
	bladesInBinding.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
	bladesInBinding.pImmutableSamplers = nullptr;

	//out culled blades:
	VkDescriptorSetLayoutBinding bladesOutBinding = {};
	bladesOutBinding.binding = 1;
	bladesOutBinding.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
	bladesOutBinding.descriptorCount = 1;
	bladesOutBinding.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
	bladesOutBinding.pImmutableSamplers = nullptr;


	//out num blades:
	VkDescriptorSetLayoutBinding OutNumBladesBinding = {};
	OutNumBladesBinding.binding = 2;
	OutNumBladesBinding.descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
	OutNumBladesBinding.descriptorCount = 1;
	OutNumBladesBinding.stageFlags = VK_SHADER_STAGE_COMPUTE_BIT;
	OutNumBladesBinding.pImmutableSamplers = nullptr;

	std::vector<VkDescriptorSetLayoutBinding> bindings = { bladesInBinding, bladesOutBinding, OutNumBladesBinding };
...
void Renderer::CreateComputeDescriptorSets() {
	...
	for (int i = 0; i < scene->GetBlades().size() * 3; i += 3) {
		...
		descriptorWrites[i].sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
		descriptorWrites[i].dstSet = computeDescriptorSet[i];
		descriptorWrites[i].dstBinding = 0;
		descriptorWrites[i].dstArrayElement = 0;
		descriptorWrites[i].descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
		descriptorWrites[i].descriptorCount = 1;
		descriptorWrites[i].pBufferInfo = &inBladesBufferInfo;
		descriptorWrites[i].pImageInfo = nullptr;
		descriptorWrites[i].pTexelBufferView = nullptr;

		descriptorWrites[i + 1].sType = VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET;
		descriptorWrites[i + 1].dstSet = computeDescriptorSet[i];
		...
		descriptorWrites[i + 1].pBufferInfo = &outBladesBufferInfo;
		...
		descriptorWrites[i + 2].dstSet = computeDescriptorSet[i];
		descriptorWrites[i + 2].dstBinding = 2;
		descriptorWrites[i + 2].dstArrayElement = 0;
		descriptorWrites[i + 2].descriptorType = VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
		descriptorWrites[i + 2].descriptorCount = 1;
		descriptorWrites[i + 2].pBufferInfo = &numBladesBufferInfo;
		descriptorWrites[i + 2].pImageInfo = nullptr;
		descriptorWrites[i + 2].pTexelBufferView = nullptr;
	}
